...
public class UserApplication {
	public static void main(String[] args) throws Exception {
		...
		while (attempts < 4 && !loginSuccess && inputUsername != null && inputPassword != null) {
		...
		// If the maximum number of login attempts has been reached, notify the user
		// that they are locked out
		if (attempts == 4 && !loginSuccess) {
